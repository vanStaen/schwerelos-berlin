...
const emailDisclaimer = `
  ...
  If you can’t tell if an email is legitimate or not, please transfer it to us at <u>info@schwerelos-berlin.com</u>. 
  ...
  <b>GDPR</b><br/>
  Schwerelos-berlin is compliant with the General Data Protection Regulation (GDPR) (EU) 2016/679. 
...
exports.mailService = {
  ...
  async mail(sendto, subject, body) {
    const requestBody = {
      "from": "Schwerelos Berlin <info@schwerelos-berlin.com>",
      "to": sendto,
      "subject": subject,
  ...
  async recover(sendto) {
    ...
    const requestBody = {
      "from": "Schwerelos Berlin <info@schwerelos-berlin.com>",
      "to": sendto,
      "subject": "Schwerelos-berlin.com | Reset your password with this link",
      "body": body,
      "key": process.env.MAILMAN_KEY
    };
